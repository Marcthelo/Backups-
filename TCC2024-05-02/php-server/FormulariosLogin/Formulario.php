...
if (isset($_POST['submit'])) {
  ...
  if ($tipo_usuario == "cliente") {
    ...
    $sql = "INSERT INTO adm (tipo_usuario, nome, cpf, senha, email, endereco, estado, cidade, nivel_acesso) VALUES ('$tipo_usuario', '$nome', '$cpf','$senha', '$email', '$endereco', '$estado', '$cidade', '$nivel_acesso')";
} else {
...
if (mysqli_query($conexao, $sql)) {
  ...
  //  $result = mysqli_query($conexao, "INSERT INTO cliente(tipo_usuario,nome,cpf,senha,email,data_nascimento,telefone,endereco,estado,cidade,nivel_acesso) VALUES('$tipo_usuario','$nome','$cpf','$senha','$email','$data_nascimento','$telefone','$endereco','$estado','$cidade','$nivel_acesso')");
    ...
    <div class="box">
        ...
        <br><br>
        <label for="nivel_acesso">Nível de Acesso (ADM):</label>
        ...
        <br><br>
            ...
            <a href=""><input id="button" type="button" value="Voltar"></a>
            </div>
