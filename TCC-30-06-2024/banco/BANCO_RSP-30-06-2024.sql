...
INSERT INTO `cliente` VALUES (1,'cliente','bianca','1654861','123','binca@gmail.com','2024-04-29','55675436','casadokrl','PR','cascavel',0,0),(2,'cliente','ABN','3','56','ABN@YAHOO.COM','2000-02-10','19','AV.BRASIL','PB','FORTAELZA',0,0),(3,'cliente','marcelo','085432','736','marceloSJ@gmail.com','2004-07-29','45998135467','Pacaembu','PR','cascavel',0,0),(5,'cliente','Andre','28976','43','andre@gmail.com','1995-11-14','5476536298','Pacaembu','PR','Cascavel',0,0);
...
CREATE TABLE `produtos` (
  ...
  `img_produto` mediumblob DEFAULT NULL,
  `descricao` varchar(220) DEFAULT NULL,
  `tipo_fabricante` varchar(200) DEFAULT NULL,
  `peca` enum('Induzido','Estator','Rotor','Bobina','Automático','Impulsor','Chaves de setas') DEFAULT NULL,
...
INSERT INTO `produtos` VALUES (22,'',_binary 'C:xampphtdocsTCC-29-06-2024ancoBanco_imgs6681cf64ef05629_abcmotoneta.jpg','motoneta guidão','WAPSA','',13),(23,'',_binary 'C:xampphtdocsTCC-29-06-2024ancoBanco_imgs6681cfaf57961EXTENSION.trator.jpg','trator foda','MAGNETI_MARELI','Bobina',41);
...
-- Dump completed on 2024-06-30 18:43:45
