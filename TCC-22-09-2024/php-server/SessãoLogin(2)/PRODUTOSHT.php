   ...
   <!-- Começo dos produtos, saída do filtro -->
    ...
    if ($db->connect_error) {
      die('Falha na conexão com o banco de dados: ' . $db->connect_error);
            ...
            $sql = "SELECT prd.id_produto, prd.nome_produto, prd.img_produto, prd.descricao, prd.tipo_fabricante,
pdd.preco, pdd.quantidade, pdd.codigo, pdd.dataProduto 
...
echo "<div class='title'><h3>$nome_produto</h3></div>";
...
echo "<div class='description'><p>R$: $preco</p></div>";
