...
<html lang="pt-br">
  ...
  <body>
    ...
    <header>
      ...
      <div id="logo"><img src="../../imgs/rsp2.png" alt="Foto-Logo" /></div>
      ...
      <div id="menuDiv">
        ...
        <div id="departamentosDiv" class="departamentosDesativo">
          <div id="departamentos1" class="departamentosDivInterior">
           <a id="departamentos" href="indexProdutos.html"><p>Carros</p></a>
           <a id="departamentos" href="indexProdutos.html"><p>Tratores</p></a> 
           <a id="departamentos" href="indexProdutos.html"><p>Caminhões</p></a>
           <a id="departamentos" href="indexProdutos.html"><p>Motocicleta</p></a> 
           <a id="departamentos" href="indexProdutos.html"><p>Motonetas</p></a> 
            <!--<p>Jorge</p>-->
          </div>
...
<!-- MENU DE PEDIDOS -->
      <div class="menuPedidos">
        <ul class="departamentosPedidos">
          <li onclick="toggleSubMenu('department1')"> 
          <h2> PEDIDOS</h2> 
        </li>
    ...
    <div id="entrar">
      <h2 id="entrarBotao"><a href="../FormulariosLogin/sair.php">SAIR</a></h2>
    </div>
