      ...
      <div id="menuDiv">
        ...
        <div id="departamentosDiv" class="departamentosDesativo">
          <div id="departamentos1" class="departamentosDivInterior">
           <a  id="corA" class="corA" href="#"><p>Carros</a></p>
           <a  id="corA" class="corA" href="#"><p>Tratores</p></a> 
           <a  id="corA" class="corA" href="#"><p>Caminhões</p></a>
           <a  id="corA" class="corA" href="#"><p>Motocicleta</p></a> 
           <a  id="corA" class="corA" href="#"><p>Motonetas</p></a> 
          </div>
...
<!-- MENU DE PEDIDOS -->
    ...
    <div id="entrar">
      <h2 id="entrarBotao"> <a href="../../php-server/FormulariosLogin/Login.php" id="corB" class="corB"> ENTRAR  </a> </h2>
    </div>
